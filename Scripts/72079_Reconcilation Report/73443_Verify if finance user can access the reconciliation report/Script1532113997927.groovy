...
'Enter Username'
WebUI.setText(findTestObject('Page_FNTG Login/input_username'), findTestData('Application').getValue(2,5))
...
'Verify if report is shown'
WebUI.verifyElementPresent(findTestObject('Object Repository/Admin_User_Page/h2_CRRAR Recon Report'), 5)
