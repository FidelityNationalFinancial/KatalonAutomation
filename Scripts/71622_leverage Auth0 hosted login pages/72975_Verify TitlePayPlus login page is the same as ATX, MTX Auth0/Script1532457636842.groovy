...
'Navigate to ATX URL '
WebUI.navigateToUrl(findTestData('Application').getValue(1, 3))

'Wait for Button <Login>'
WebUI.waitForElementPresent(findTestObject('Page_FNTG Login/button_Log In'), 20)

'Verify same login page is displayed'
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_FNF - Atx Login/h3_Welcome to the FNTG Agency'), 0)
